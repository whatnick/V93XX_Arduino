...
void setup() {
    ...
    raccoon.ConfigureBlockRead((const uint8_t[]){DSP_DAT_PA1, DSP_DAT_QA1, DSP_DAT_RMS1UA, DSP_DAT_RMS1IA,
                                                 DSP_DAT_RMS1IB, DSP_DAT_FRQ, DSP_DAT_PB1, DSP_DAT_QB1, DSP_DAT_SA1,
                                                 DSP_DAT_SB1},
                               10);
}
