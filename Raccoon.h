...
//bit31-30 adcʱ��Ƶ��800K  BIT22-21  6.5M is on, BGP is on, BIT18-16 voltage, A channel, B channel adc is on, BIT15 is set to 1 only when using 13M crystal oscillator
